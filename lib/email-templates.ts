...
const LOGO_HTML = `<a href="${STORE_URL}" style="text-decoration:none;display:inline-block;"><img src="${LOGO_URL}" alt="BED Design" width="130" height="29" style="display:block;border:0;" /></a>`
...
function p(text: string, size = '16px', color = '#44526E'): string {
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#F5F2EE;min-width:320px;">
...
<p style="margin:0 0 6px;font-family:Arial,sans-serif;font-size:13px;line-height:1.6;"><a href="${STORE_URL}" style="color:#1D2235;text-decoration:none;font-weight:600;">BED Design</a></p>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr>
    <td style="padding:6px 0;"><table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr>
      <td width="20" style="color:#1D7A72;font-size:16px;line-height:1;">&#10003;</td>
      <td style="font-family:Arial,sans-serif;font-size:14px;color:#1D7A72;padding-left:8px;">Pedido recebido e pagamento confirmado</td>
    </tr></table></td>
  </tr>
  <tr>
    <td style="padding:6px 0;"><table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr>
      <td width="20" bgcolor="#C8552A" style="background-color:#C8552A;border-radius:50%;width:18px;height:18px;text-align:center;line-height:18px;font-size:10px;color:#fff;font-weight:700;">&#9654;</td>
      <td style="font-family:Arial,sans-serif;font-size:14px;color:#C8552A;font-weight:600;padding-left:8px;">Em produ&ccedil;&atilde;o agora</td>
    </tr></table></td>
  </tr>
  <tr>
    <td style="padding:6px 0;"><table role="presentation" cellpadding="0" cellspacing="0" border="0"><tr>
...
<tr><td align="center" bgcolor="#EFF6FF" style="background-color:#EFF6FF;border:1px solid #BFDBFE;border-radius:10px;padding:28px 24px;">
  <p style="font-family:Arial,sans-serif;font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:#2563EB;margin:0 0 10px;font-weight:600;">C&oacute;digo de rastreio</p>
  ...
  ${btn('Rastrear nos Correios', 'https://www.correios.com.br/rastrear-encomendas?objetos={{trackingCode}}', '#2563EB')}
</td></tr>
</table>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
  <tr><td style="font-family:Arial,sans-serif;font-size:14px;color:#44526E;padding:5px 0;"><strong style="color:#1D2235;">Pix:</strong> at&eacute; 1 dia &uacute;til</td></tr>
  <tr><td style="font-family:Arial,sans-serif;font-size:14px;color:#44526E;padding:5px 0;"><strong style="color:#1D2235;">Cart&atilde;o de cr&eacute;dito:</strong> at&eacute; 2 faturas (conforme banco emissor)</td></tr>
  <tr><td style="font-family:Arial,sans-serif;font-size:14px;color:#44526E;padding:5px 0;"><strong style="color:#1D2235;">Boleto:</strong> at&eacute; 5 dias &uacute;teis</td></tr>
</table>`, '#F5F0FF', '#DDD6FE')}
...
${infoBox(`<p style="font-family:Arial,sans-serif;font-size:13px;color:#44526E;margin:0;line-height:1.6;">&#9203;&nbsp; <strong>O link expira em 1 hora.</strong> Se n&atilde;o funcionar mais, solicite outro acesso pelo painel de login.</p>`, '#FFFBEB', '#FCD34D')}

${hr()}

${p('Se o bot&atilde;o n&atilde;o funcionar, copie e cole este link no navegador:', '13px', '#6B7494')}
<p style="font-family:'Courier New',Courier,monospace;font-size:12px;color:#2563EB;word-break:break-all;margin:0 0 20px;line-height:1.6;">{{resetUrl}}</p>
...
<tr><td align="center" bgcolor="#F8F5F2" style="background-color:#F8F5F2;border:2px dashed #D8B8A8;border-radius:12px;padding:36px 24px;">
  <p style="font-family:'Courier New',Courier,monospace;font-size:48px;font-weight:700;color:#C8552A;margin:0;letter-spacing:14px;text-align:center;">{{code}}</p>
</td></tr>
</table>

${p('N&atilde;o compartilhe este c&oacute;digo com ningu&eacute;m. A BED Design nunca solicitar&aacute; seu c&oacute;digo por telefone ou chat.', '13px', '#6B7494')}
